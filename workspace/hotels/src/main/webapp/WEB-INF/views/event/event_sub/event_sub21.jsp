...
<section id="container">
   ...
   <div class="eventViewWrap innerBox">
      <h1>EVENTS</h1>
      <div class="viewBox">
         <h2>모던 차이니즈 중식의 명가, 남풍(南風)</h2>
         
            <p class="img"></p><p><img alt="null" src="/images/event/nampoonggogi.jpg"></p>
<p></p>
         ...
         <div class="viewBtnGroup">
            <a href="/event/eventView?SBU_CD=&P_SEQ=20&PAGE_SIZE=9&PAGE_NO=1&ORDER_COLUMN=1" class="btnPrev"><span>이전 글로</span></a>
            <a href="/event" class="btnList">목록으로</a>   <!-- href: javascript:jsList() -->
            <a href="/event/eventView?SBU_CD=&P_SEQ=22&PAGE_SIZE=9&PAGE_NO=1&ORDER_COLUMN=1" class="btnNext"><span>다음 글로</span></a>
         </div>
