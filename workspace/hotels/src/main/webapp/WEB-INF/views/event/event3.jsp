		...
		<div class="eventBox">
			...
			<div class="searchTab clearFixed">
				...
				<ul class="eventList clearFixed">
					...
					<li data-animation="fadeInUp">
						<a href="javascript:jsView('20')">
							<p class="img"><img src="https://www.busanparadisehotel.co.kr/upload/202103/1616744804916.jpg" alt=""></p>
							<div class="txt">
								<strong>3代가함께하는 중식당 남풍</strong>
								<span class="sub">웃음과 감사, 사랑이 함께하는 가족과의 만남 삼대가 함께라면 더욱 좋은 남풍에서 준비하세요!</span>
...
<a href='javascript:jsSearch(2);' class='direction prev'>이전</a>
<a href='javascript:jsSearch(1);' class='num'>1</a>
