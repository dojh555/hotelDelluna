...
<section id="container">
   ...
   <form id="form1" name="form1">
      ...
      <!--     <input type="hidden" id="P_SEQ" name="P_SEQ" value="1">
      <input type="hidden" id="SBU_CD" name="SBU_CD" value="">
      <input type="hidden" id="PAGE_SIZE" name="PAGE_SIZE" value="9">
      <input type="hidden" id="PAGE_NO" name="PAGE_NO" value="1">
   ...
   <div class="eventViewWrap innerBox">
      ...
      <div class="viewBox">
         <h2>REVIATALSING! SUMMER LEMON SPA</h2>
            ...
            <p class="img"></p><p><img alt="null" src="/images/event/lemon.jpg"></p>
<p></p>
         

         <div class="cont">
            <p class="text">여름엔 상큼하게 레몬!! 생기를 깨우는 상쾌한 레몬 씨메르</p>
            <p class="date">2021.07.16(금) ~ 2021.08.31(화)</p>
            <div class="share">
            <ul class="uls">
         ...
         <div class="viewBtnGroup">
            <a href="#" class="btnPrev" style="display: none;"><span>이전 글로</span></a>
            <a href="/event" class="btnList">목록으로</a>   <!-- href: javascript:jsList() -->
            <a href="/event/eventView?SBU_CD=&P_SEQ=2&PAGE_SIZE=9&PAGE_NO=1&ORDER_COLUMN=1" class="btnNext"><span>다음 글로</span></a>
         </div>
