...
<section id="container">
   ...
   <div class="eventViewWrap innerBox">
      <h1>EVENTS</h1>
      <div class="viewBox">
         <h2>시원한 여름을 보내기 위한 남풍 해물 냉짬뽕</h2>
         
            <p class="img"></p><p><img alt="null" src="/images/event/nampoong.jpg"></p>
<p></p>
         

         <div class="cont">
            <p class="text">살얼음이 동동, 담백하고 시원한 특제 육수에 탱글탱글한 면발과 다양한 해산물이 어우러진 남풍 여름철 별미를 즐겨보세요!</p>
            <p class="date">상시</p>
            <div class="share">
            <ul class="uls">
         ...
         <div class="viewBtnGroup">
            <a href="/event/eventView?SBU_CD=&P_SEQ=9&PAGE_SIZE=9&PAGE_NO=1&ORDER_COLUMN=1" class="btnPrev"><span>이전 글로</span></a>
            <a href="javascript:jsList()" class="btnList">목록으로</a>   <!-- href: javascript:jsList() -->
            <a href="/event/eventView?SBU_CD=&P_SEQ=11&PAGE_SIZE=9&PAGE_NO=1&ORDER_COLUMN=1" class="btnNext"><span>다음 글로</span></a>
         </div>
