...
<section id="container">
   ...
   <div class="eventViewWrap innerBox">
      <h1>EVENTS</h1>
      <div class="viewBox">
         <h2>ALOHA! TROPICAL WEDDING</h2>
         
            <p class="img"></p><p><img alt="null" src="/images/event/flowers.jpg"></p>
<p></p>
         

         <div class="cont">
            <p class="text">트로피칼 무드의 이국적인 데코레이션과 함께 특별한 웨딩을 합리적인 가격으로 파라다이스 호텔 부산에서 제안합니다.</p>
            <p class="date">2021.07.17(토) ~ 2021.09.26(일)</p>
            <div class="share">
            <ul class="uls">
         ...
         <div class="viewBtnGroup">
            <a href="/event/eventView?SBU_CD=&P_SEQ=11&PAGE_SIZE=9&PAGE_NO=1&ORDER_COLUMN=1" class="btnPrev" ><span>이전 글로</span></a>
            <a href="javascript:jsList()" class="btnList">목록으로</a>   <!-- href: javascript:jsList() -->
            <a href="/event/eventView?SBU_CD=&P_SEQ=13&PAGE_SIZE=9&PAGE_NO=1&ORDER_COLUMN=1" class="btnNext"><span>다음 글로</span></a>
         </div>
