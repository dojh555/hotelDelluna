...
<section id="container">
   ...
   <div class="eventViewWrap innerBox">
      <h1>EVENTS</h1>
      <div class="viewBox">
         <h2>FICKLE PICKLE & MALIBU BEACH BAR</h2>
         
            <p class="img"></p><p><img alt="null" src="/images/event/ocean.jpg"></p>
<p></p>
         

         <div class="cont">
            <p class="text">파라다이스 오션풀과 피클피클의 만남</p>
            <p class="date">2021.05.21(금) ~ 2021.07.28(수)</p>
            <div class="share">
            <ul class="uls">
         ...
         <div class="viewBtnGroup">
            <a href="/event/eventView?SBU_CD=&P_SEQ=6&PAGE_SIZE=9&PAGE_NO=1&ORDER_COLUMN=1" class="btnPrev"><span>이전 글로</span></a>
            <a href=" javascript:jsList()" class="btnList">목록으로</a>   <!-- href: javascript:jsList() -->
            <a href="/event/eventView?SBU_CD=&P_SEQ=8&PAGE_SIZE=9&PAGE_NO=1&ORDER_COLUMN=1" class="btnNext"><span>다음 글로</span></a>
         </div>
