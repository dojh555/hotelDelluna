...
<section id="container">
   ...
   <div class="eventViewWrap innerBox">
      <h1>EVENTS</h1>
      <div class="viewBox">
         <h2>이그제큐티브 라운지 애프터눈 티 타임 서비스</h2>
         
            <p class="img"></p><p><img alt="null" src="/images/event/sweetdes.jpg"></p>
<p></p>
         

         <div class="cont">
            <p class="text">스위트(SUITE) 객실 고객을 위한 스위트(SWEET) 한 여유</p>
            <p class="date">2021.07.16(금) ~ 2021.08.21(토)</p>
            <div class="share">
            <ul class="uls">
         ...
         <div class="viewBtnGroup">
            <a href="/event/eventView?SBU_CD=&P_SEQ=5&PAGE_SIZE=9&PAGE_NO=1&ORDER_COLUMN=1" class="btnPrev"><span>이전 글로</span></a>
            <a href="javascript:jsList()" class="btnList">목록으로</a>   <!-- href: javascript:jsList() -->
            <a href="/event/eventView?SBU_CD=&P_SEQ=7&PAGE_SIZE=9&PAGE_NO=1&ORDER_COLUMN=1" class="btnNext"><span>다음 글로</span></a>
         </div>
