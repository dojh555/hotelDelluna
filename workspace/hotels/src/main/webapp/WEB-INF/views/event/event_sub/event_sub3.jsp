...
<section id="container">
   ...
   <div class="eventViewWrap innerBox">
      <h1>EVENTS</h1>
      <div class="viewBox">
         <h2>GREEN PARADISE KIDS PARADISE</h2>
         
            <p class="img"></p><p><img alt="null" src="/images/event/kids.jpg"></p>
<p></p>
         

         <div class="cont">
            <p class="text">환경의 소중함과 자연을 사랑하는 마음을 키우는 시간!</p>
            <p class="date">2021.07.31(토) ~ 2021.08.15(일)</p>
            <div class="share">
            <ul class="uls">
         ...
         <div class="viewBtnGroup">
            <a href="/event/eventView?SBU_CD=&P_SEQ=2&PAGE_SIZE=9&PAGE_NO=1&ORDER_COLUMN=1" class="btnPrev"><span>이전 글로</span></a>
            <a href="javascript:jsList()" class="btnList">목록으로</a>   <!-- href: javascript:jsList() -->
            <a href="/event/eventView?SBU_CD=&P_SEQ=4&PAGE_SIZE=9&PAGE_NO=1&ORDER_COLUMN=1" class="btnNext"><span>다음 글로</span></a>
         </div>
