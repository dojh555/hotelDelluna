...
<section id="container">
   ...
   <div class="eventViewWrap innerBox">
      <h1>EVENTS</h1>
      <div class="viewBox">
         <h2>3代가함께하는 중식당 남풍</h2>
         
            <p class="img"></p><p><img alt="null" src="/images/event/hahaha.jpg"></p>
<p></p>
         ...
         <div class="viewBtnGroup">
            <a href="/event/eventView?SBU_CD=&P_SEQ=19&PAGE_SIZE=9&PAGE_NO=1&ORDER_COLUMN=1" class="btnPrev" ><span>이전 글로</span></a>
            <a href="javascript:jsList()" class="btnList">목록으로</a>
            <a href="/event/eventView?SBU_CD=&P_SEQ=21&PAGE_SIZE=9&PAGE_NO=1&ORDER_COLUMN=1" class="btnNext"><span>다음 글로</span></a>
         </div>
