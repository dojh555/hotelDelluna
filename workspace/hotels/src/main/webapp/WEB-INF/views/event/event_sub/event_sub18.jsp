...
<section id="container">
   ...
   <div class="eventViewWrap innerBox">
      <h1>EVENTS</h1>
      <div class="viewBox">
         <h2>양념 소갈비 밀키트 투고 박스</h2>
         
            <p class="img"></p><p><img alt="null" src="/images/event/galbi.jpg"></p>
<p></p>
         

         <div class="cont">
            <p class="text">델루나호텔 부산 온 더 플레이트 No.1 인기 메뉴 '양념 소갈비' 이제 집에서도 간편하게 즐겨보세요.</p>
            <p class="date">상시</p>
            <div class="share">
            <ul class="uls">
         ...
         <div class="viewBtnGroup">
            <a href="/event/eventView?SBU_CD=&P_SEQ=17&PAGE_SIZE=9&PAGE_NO=1&ORDER_COLUMN=1" class="btnPrev"><span>이전 글로</span></a>
            <a href="/event" class="btnList">목록으로</a>   <!-- href: javascript:jsList() -->
            <a href="/event/eventView?SBU_CD=&P_SEQ=19&PAGE_SIZE=9&PAGE_NO=1&ORDER_COLUMN=1" class="btnNext"><span>다음 글로</span></a>
         </div>
