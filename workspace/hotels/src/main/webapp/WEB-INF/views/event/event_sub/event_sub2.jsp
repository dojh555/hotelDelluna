...
<section id="container">
   ...
   <div class="eventViewWrap innerBox">
      <h1>EVENTS</h1>
      <div class="viewBox">
         <h2>REVIATALSING! SUMMER LEMON SPA</h2>
         
            <p class="img"></p><p><img alt="null" src="/images/event/hawaii.jpg"></p>
<p></p>
         

         <div class="cont">
            <p class="text">올해 해운대 가고, 내년에 하와이 가자!</p>
            <p class="date">2021.06.30(수) ~ 2021.09.03(금)</p>
            <div class="share">
            <ul class="uls">
         ...
         <div class="viewBtnGroup">
            <div id="evn1"><a href="/event/eventView?SBU_CD=&P_SEQ=1&PAGE_SIZE=9&PAGE_NO=1&ORDER_COLUMN=1" class="btnPrev" ><span>이전 글로</span></a></div>
            <a href="javascript:jsList()" class="btnList">목록으로</a>   <!-- href:  -->
            <a href="/event/eventView?SBU_CD=&P_SEQ=3&PAGE_SIZE=9&PAGE_NO=1&ORDER_COLUMN=1" class="btnNext"><span>다음 글로</span></a>
         </div>
