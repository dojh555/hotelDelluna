	...
	<div class="hotelParadiseWrap">
		<div class="innerBox">
			...
			<ul class="eventTab clearFixed">
				...
				<li>
					<a href="javascript:;" onclick="jsTapChange('rooms','deluxe','ot')">본관</a>
				</li>
				
				<li class="on" >
					<a href="javascript:;" onclick="jsTapChange('rooms','deluxe','ot-new')">신관</a>
				</li>
			...
			<section class="jsSwiperMotion keyVisual">
				<div class="swiperWrap">
					<ul>
						...
						<li>
							<p class="img">
								<img src="/images/rooms/deluxe/1555488295109.jpg" alt="" />
							</p>
						</li>
						
						<li>
							<p class="img">
								<img src="/images/rooms/deluxe/1555488298303.jpg" alt="" />
							</p>
						</li>
						<li>
							<p class="img">
								<img src="/images/rooms/deluxe/1555488301305.jpg" alt="" />
							</p>
						</li>
						<li>
							<p class="img">
								<img src="/images/rooms/deluxe/1555488304105.jpg" alt="" />
							</p>
						</li>
					</ul>
				</div>
			...
			<div class="detailTextBox">
				...
				<div class="text">모던하면서도 세련된 최신 트렌드의 인테리어가 돋보이는 객실로 파라다이스만의 고급스러운 감각이 곳곳에 배어 있습니다</div>
				<div class="btnGroup">
	...
	<div class="layerPopCont" style="width: 864px;">
		...
		<div class="mapPop tc">
			...
			<div class="tapView on" >
				<img src="/images/rooms/common/1554957641615.jpg" alt="" />
			</div>
			
			<div class="tapView" >
				<img src="/images/rooms/common/1554957641660.jpg" alt="" />
			</div>
