	...
	<div class="hotelParadiseWrap">
		<div class="innerBox">
			...
			<ul class="eventTab clearFixed">
				<li class="on">
					<a href="javascript:;" onclick="jsTapChange('rooms','premiumdeluxe','tween-new')">신관</a>
				</li>
			</ul>
			...
			<section class="jsSwiperMotion keyVisual">
				<div class="swiperWrap">
					<ul>
						...
						<li>
							<p class="img">
								<img src="/images/rooms/premiumdeluxe/1554963836581.jpg" alt="" />
							</p>
						</li>
						
						<li>
							<p class="img">
								<img src="/images/rooms/premiumdeluxe/1554963836961.jpg" alt="" />
							</p>
						</li>
					</ul>
				</div>
			...
			<div class="detailTextBox">
				<h2>프리미엄 디럭스 오션 트윈</h2>
				<p class="subTit">부서지는 파도를 감싸안는 해운대 해변을 정면으로 마주할 수 있는 객실</p>
				<div class="text">더욱 여유로워진 객실, 프리미엄 디럭스룸을 만나다!<br/>아침 햇살에 부서지는 파도를 감싸안는 해운대 해변을 정면으로 마주할 수 있는 프리미엄 디럭스 오션 룸 <br/><br/>더블 베드 x 2개 비치<br/>최상의 아늑함을 전해줄 더블 베드가 2개 놓여 있어, 3~4인의 가족 혹은 친구들과 여행 시 편안한 휴식이 가능합니다.<br/><br/>Ocean view<br/>탁 트인 통 유리창을 통해 아침 햇살에 맑게 빛나는 비취 빛 해운대 바다를 정면으로 마주할 수 있는 즐거움이 있습니다</div>
				<div class="btnGroup">
					
					<a href="/images/rooms/common/1554959488244.pdf" target="Inroom" class="btn small layerPopOpen"><span>인룸다이닝</span></a>
			...
			<div class="detailInfo">
				...
				<div class="infoDetail">
					...
					<dl>
						...
						<dd>
							<ul class="dotList">
								<li>베쓰 어메니티 5종</li><li>목욕용 가운 2개</li><li>페이스, 핸드 타올</li><li>베스 타올</li><li>샤워캡</li><li>빗</li><li>면봉</li><li>헤어드라이어</li>
							</ul>
						</dd>
					</dl>
					<dl>
				...
				<section class="jsSwiperMotion">
					<div class="swiperWrap" data-show="2">
						<ul>
							...
							<li>
								<p class="img">
									<img src="/images/rooms/common/1553929057604.jpg" alt="" />
								</p>
								<h4>네스프레소 커피머신</h4>
								<p class="text">
									한가로운 오후, 커피의 부드러움에 빠지다!<br/>네스프레소 커피 전문가들의 기술력으로 블랜딩, 로스팅, 그라이딩되어 더욱 풍성해진 커피를 즐겨보세요.
								</p>
							</li>
						</ul>
					</div>
			...
			<div class="cautionBox type2">
				...
				<ul class="dotList">
					<li>Check out 시간 초과 시 추가 요금 부과됩니다. (15:00 까지 : 객실 요금 50% / 15:00 이후 : 객실 요금 100%)</li><li>Late Check out은 사전 요청 시 한함. (체크 아웃 시간에 따라 요금이 부과됩니다.)</li><li>오션뷰 객실은 테라스가 없으며 해안가 측면 전경입니다. 객실 층에 따라 부득이하게 약간의 전경 차이가 있으니 이 점 양지하여 주시기 바랍니다.</li><li>전 객실은 금연구역으로 지정되어 있습니다.</li><li>호텔 내 스파 부대시설(씨메르, 오션풀, 사우나, 피트니스 클럽, 실내골프 등)은 매월 넷째주 수요일 휴무입니다.  </br>호텔 사정에 따라 변경될 수 있으니 예약 시 참고하시기 바랍니다.</li>
				</ul>
			</div>
...
<div class="layerPopWrap normalLayer" id="map">
	...
	<div class="layerPopCont" style="width: 864px;">
		...
		<div class="mapPop tc">
			<img src="/images/rooms/common/1554963844374.jpg" alt="" />
		</div>
