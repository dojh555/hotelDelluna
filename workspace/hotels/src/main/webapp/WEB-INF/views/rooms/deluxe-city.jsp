	...
	<div class="hotelParadiseWrap">
		<div class="innerBox">
			...
			<ul class="eventTab clearFixed">
				...
				<li class="on" >
					<a href="javascript:;" onclick="jsTapChange('rooms','deluxe','city')">본관</a>
				</li>
				
				<li>
					<a href="javascript:;" onclick="jsTapChange('rooms','deluxe','city-new')">신관</a>
				</li>
			...
			<section class="jsSwiperMotion keyVisual">
				<div class="swiperWrap">
					<ul>
						...
						<li>
							<p class="img">
								<img src="/images/rooms/deluxe/1555489453085.jpg" alt="" />
							</p>
						</li>
						
						<li>
							<p class="img">
								<img src="/images/rooms/deluxe/1555489454837.jpg" alt="" />
							</p>
						</li>
						
						<li>
							<p class="img">
								<img src="/images/rooms/deluxe/1555489456820.jpg" alt="" />
							</p>
						</li>
			...
			<div class="detailTextBox">
				<h2>디럭스 시티</h2>
				<p class="subTit">은은한 조명과 어우러진 다크 브라운의 조화</p>
				<div class="text">모던하면서도 세련된 최신 트렌드의 인테리어가 돋보이는 객실로 파라다이스만의 고급스러운 감각이 곳곳에 배어 있습니다.<br/></div>
				<div class="btnGroup">
			...
			<div class="detailInfo">
				...
				<div class="infoDetail">
					...
					<dl>
						...
						<dd>
							<ul class="dotList">
								<li>배쓰 어메니티 5종</li><li>목욕용 가운 2개</li><li>페이스, 핸드 타올</li><li>베스 타올</li><li>샤워캡</li><li>빗</li><li>면봉</li><li>헤어드라이어</li>
							</ul>
						</dd>
					</dl>
					<dl>
			...
			<div class="cautionBox type2">
				...
				<ul class="dotList">
					<li>Check out 시간 초과 시 추가 요금 부과됩니다. (15:00 까지 : 객실 요금 50% / 15:00 이후 : 객실 요금 100%)</li><li>Late Check out은 사전 요청 시 한함. (체크 아웃 시간에 따라 요금이 부과됩니다.)</li><li>온돌 타입은 1실 성인 2인 + 어린이2인(초등학생 이하) 또는 성인 3인까지만 최대 투숙 가능합니다.</li><li>온돌 타입은 한국형 온돌 마루로 설계되어 있어 원하시는 온도 설정까지 일정 시간이 소요될 수 있습니다.</li><li>온돌 타입은 업무용 데스크가 비치되어 있지 않습니다.</li><li>전 객실은 금연구역으로 지정되어 있습니다.</li><li>호텔 내 스파 부대시설(씨메르, 오션풀, 사우나, 피트니스 클럽, 실내골프 등)은 매월 넷째주 수요일 휴무입니다.  </br>호텔 사정에 따라 변경될 수 있으니 예약 시 참고하시기 바랍니다.</li>
				</ul>
			</div>
...
<div class="layerPopWrap normalLayer" id="map">
	...
	<div class="layerPopCont" style="width: 864px;">
		...
		<div class="mapPop tc">
			...
			<div class="tapView on" >
				<img src="/images/rooms/common/1554959470261.jpg" alt="" />
			</div>
			
			<div class="tapView" >
				<img src="/images/rooms/common/1554959474096.jpg" alt="" />
			</div>
			
			<div class="tapView" >
				<img src="/images/rooms/common/1554959476852.jpg" alt="" />
			</div>
