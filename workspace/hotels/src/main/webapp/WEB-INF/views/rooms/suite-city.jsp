	...
	<div class="hotelParadiseWrap">
		<div class="innerBox">
			...
			<ul class="eventTab clearFixed">
				...
				<li class="on" >
					<a href="javascript:;" onclick="jsTapChange('rooms','suite','city')">본관</a>
				</li>
			</ul>
			...
			<section class="jsSwiperMotion keyVisual">
				<div class="swiperWrap">
					<ul>
						<li>
							<p class="img">
								<img src="/images/rooms/suite/1555901135289.jpg" alt="" />
							</p>
						</li>
						<li>
							<p class="img">
								<img src="/images/rooms/suite/1555901137058.jpg" alt="" />
							</p>
						</li>
						<li>
							<p class="img">
								<img src="/images/rooms/suite/1555901139171.jpg" alt="" />
							</p>
						</li>
						<li>
							<p class="img">
								<img src="/images/rooms/suite/1555901141187.jpg" alt="" />
							</p>
						</li>
						<li>
							<p class="img">
								<img src="/images/rooms/suite/1555901143443.jpg" alt="" />
							</p>
						</li>
					</ul>
				</div>
			...
			<div class="detailTextBox">
				<h2>스위트 시티</h2>
				<p class="subTit">편안한 침실과 안락한 거실이 분리되어 품격 있는 휴식을 누릴 수 있는 스위트 룸</p>
				<div class="text">편안한 침실과 안락한 거실이 분리되어 있어 품격 있는 휴식을 누리실 수 있으며 간결하게 정돈된 다크 브라운 톤으로 본관 특유의 세련되면서도 모던한 감각이 배어 있습니다.</div>
				<div class="btnGroup">
	...
	<div class="layerPopCont" style="width: 864px;">
		...
		<div class="mapPop tc">
			...
			<div class="tapView on" >
				<img src="/images/rooms/common/1578447540512.jpg" alt="" />
			</div>
			
			<div class="tapView" >
				<img src="/images/rooms/common/1578447546621.jpg" alt="" />
			</div>
		</div>
