	...
	<div class="hotelParadiseWrap">
		<div class="innerBox">
			...
			<ul class="eventTab clearFixed">
				<li class="on">
					<a href="javascript:;" onclick="jsTapChange('rooms','premiumdeluxe','double-new')">신관</a>
				</li>
			</ul>
			...
			<section class="jsSwiperMotion keyVisual">
				<div class="swiperWrap">
					<ul>
						...
						<li>
							<p class="img">
								<img src="/images/rooms/premiumdeluxe/1555489782886.jpg" alt="" />
							</p>
						</li>
						
						<li>
							<p class="img">
								<img src="/images/rooms/premiumdeluxe/1555489784898.jpg" alt="" />
							</p>
						</li>
					</ul>
				</div>
...
<div class="layerPopWrap normalLayer" id="map">
	...
	<div class="layerPopCont" style="width: 864px;">
		...
		<div class="mapPop tc">
			<img src="/images/rooms/common/1554963953127.jpg" alt="" />
		</div>
