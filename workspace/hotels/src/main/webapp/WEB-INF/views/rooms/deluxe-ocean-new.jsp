	...
	<div class="hotelParadiseWrap">
		<div class="innerBox">
			...
			<ul class="eventTab clearFixed">
				<li class="on">
					<a href="javascript:;" onclick="jsTapChange('rooms','deluxe','ocean-new')">신관</a>
				</li>
			...
			<section class="jsSwiperMotion keyVisual">
				<div class="swiperWrap">
					<ul>
						...
						<li>
							<p class="img">
								<img src="/images/rooms/deluxe/1555488907950.jpg" alt="" />
							</p>
						</li>
						
						<li>
							<p class="img">
								<img src="/images/rooms/deluxe/1555488910257.jpg" alt="" />
							</p>
						</li>
						
						<li>
							<p class="img">
								<img src="/images/rooms/deluxe/1555488912881.jpg" alt="" />
							</p>
						</li>
			...
			<div class="detailTextBox">
				...
				<div class="text">은은한 베이지 톤의 정갈한 분위기에서 느낄 수 있는 편안함과 여유로움... 본관 객실과는 또 다른 클래식한 느낌을 전합니다.</div>
				<div class="btnGroup">
	...
	<div class="layerPopCont" style="width: 864px;">
		...
		<div class="mapPop tc">
			...
			<div class="tapView on" >
				<img src="/images/rooms/common/1555488702052.jpg" alt="" />
			</div>
			
			<div class="tapView" >
				<img src="/images/rooms/common/1555488705765.jpg" alt="" />
			</div>
