				...
				<div class="purchaseBox">
					<ul class="basicList">
						<li class="clearFixed"><span>예약상태</span> <span><strong
								class="txtRed">${newRsvState}</strong></span></li>
						<li class="clearFixed">
							<span>체크인</span> <span>${newRsvIn}</span> ~
							<span>체크아웃</span> <span>${newRsvOut}</span>
						</li>
					</ul>
				</div>
				<ul class="buttonBox clearFixed">
					<li><a href="/mypage/reservation" class="btn"><span>예약 확인하기</span></a></li>
