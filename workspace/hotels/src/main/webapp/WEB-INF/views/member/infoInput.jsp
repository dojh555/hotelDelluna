...
<section id="container">
	<div class="loginWrap">
		...
		<!-- 회원정보입력 시작 -->
		<form method="post" name="form1" id="form1" action="/member/addMember">
			<div class="fullBg">
					...
					<div class="formInfo clearFixed">
						...
						<div class="left">
							...
							<dl class="phone type1">
								<dt><label for="tel">휴대폰 번호<span class="color">*</span></label></dt>
								<dd>
									<div class="inp">
							...
							<dl class="email">
								...
								<dd>
									<div class="inp">
									<input type="email" id="email" name="email" value="${email}"  placeholder="" title="Email" readonly="readonly" maxlength="64">
										<button type="button" class="btnDelete" style="display: none;">삭제</button>
									</div>
									<div class="errorText">
										<!-- 에러 메시지 -->
